...
1.  **Create a Gatsby site.**
    ...
    gatsby new my-default-starter https://github.com/arobida/gatsby-basic-template
    ```
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/arobida/gatsby-basic-template)
